...
- 각 레벨은 1.0초 ~ 0.1초의 생성 시간을 가짐
   - 스테이지 0: 1.0초 간격으로 기본 좀비만 생성
   - 스테이지 1 ~ 4: 모든 좀비 생성
   - 스테이지 5 ~ 7: 기본 좀비와 원거리 또는 탱커 좀비 생성
   - 스테이지 8: 기본 좀비 2마리와 원거리 또는 탱커 좀비 생성
   - 스테이지 9: 기본 좀비 2마리, 원거리 1마리, 탱커 1마리 총 4마리 생성
...
### [Commit Insights]
![image](https://github.com/user-attachments/assets/bd4e21a1-6e5c-4450-b8d9-96bf0d27b429)
![화면 캡처 2024-12-07 113147](https://github.com/user-attachments/assets/0f116e9a-0988-4f1a-b213-c2fad6f8b8a1)
...
4. 충돌 처리.
5. 공통 변수 분리.
6. InfinityBackground
7. 이외에도 대부분의 기능 및 함수들이 수업내용을 차용해 작성되었다 생각.
...
3. 충돌처리 기법에 대한 이해.
4. GFW의 개념
5. 중앙에서 처리하는 방식이 항상 좋은 방향은 아니라는 점.
